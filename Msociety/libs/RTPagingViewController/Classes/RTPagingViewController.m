...
- (void)commonInit
{
    ...
    //self.titleColor = [UIColor colorWithWhite:184.0/255alpha:1.0];
    //self.selectedTitleColor = [UIColor colorWithWhite:124.0/255alpha:1.0];
    UIFont *font = [UIFont fontWithName:@"THSarabunNew-Bold" size:15.0f];
    
    self.titleFont = font;
    
    self.titleViewHeight = 45.f;
